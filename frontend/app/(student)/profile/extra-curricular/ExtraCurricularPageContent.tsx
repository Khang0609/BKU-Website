...
import { useExtraCurricularContext } from "@/app/(student)/_context/ExtraCurricularContext";
...
export const ExtraCurricularPageContent = () => {
  const { extraCurriculars, isLoading, error } = useExtraCurricularContext();
